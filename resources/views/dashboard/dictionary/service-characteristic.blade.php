...
<div class="content-wrapper">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#subchild-MNU32").addClass("nav-link active")
        });
        ...
        function loadData(page = 1, start = 1, limit = 25, search = "") {
            ...
            $.ajax({
                url: `/getCharacteristicsM?action=getCharacteristicsM&page=${page}&start=${start}&limit=${limit}&filter=[{"operator":"eq","value":"Service","property":"transaction_type","type":"string"},{"operator":"like","value":"${search}","property":"mrcode_characteristic","type":"string"}]`,
                type: 'get',
                dataType: 'json',
                success: function(response) {
