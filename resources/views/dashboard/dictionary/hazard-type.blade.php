...
@section('title','Dictionary | Hazard Type')
@section('content')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid mt-3">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">List Hazard Type</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Dictionary</li>
                        <li class="breadcrumb-item active">Hazard Type</li>
                    </ol>
                </div><!-- /.col -->
                <p id="menu"></p>
            </div><!-- /.row -->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#subchild-MNU21").addClass("nav-link active")
        });
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            data: {
                                _token: csrf_token,
                                entity_name: 'hazard',
                                data_items: `[{"flag":"Insert","id":"model_hazard_type-1","code":"${code}","description":"${description}"}]`
                            },
        ...
        function loadData(page = 1, start = 1, limit = 25, search = "") {
            ...
            $.ajax({
                url: `/get-abbreviation?action=getEntity&page=${page}&start=${start}&limit=${limit}&filter=[{"operator":"like","value":"${search}","property":"entity_code_name","type":"string"},{"operator":"like","value":"hazard","property":"entity_name","type":"string"}]`,
                type: 'get',
                dataType: 'json',
                success: function(response) {
