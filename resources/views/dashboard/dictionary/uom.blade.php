...
<div class="content-wrapper">
    ...
    <script>
        ...
        function addData() {
            document.getElementById("titlemodalForm").innerHTML = "Add UOM"
        ...
        function updateData(code, description, id) {
            document.getElementById("titlemodalForm").innerHTML = "Update UOM"
            ...
            if (code == '' && desc == '') {
                ...
                $.ajax({
                    ...
                    data: {
                        _token: csrf_token,
                        entity_name: "uom",
                        data_items: `[{"flag":"Insert","id":"model_UOM-2","code":"${code}","description":"${desc}"}]`
                    },
        ...
        function loadData(page = 1, start = 1, limit = 25, search = "") {
            ...
            $.ajax({
                url: `/get-abbreviation?action=getEntity&page=${page}&start=${start}&limit=${limit}&filter=[{"operator":"like","value":"uom","property":"entity_name","type":"string"},{"operator":"like","value":"${search}","property":"entity_code_name","type":"string"}]`,
                type: 'get',
                dataType: 'json',
                success: function(response) {
