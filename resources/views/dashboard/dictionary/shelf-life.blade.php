...
@section('title','Dictionary | Shelf Life')
@section('content')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid mt-3">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">List Shelf Life</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Dictionary</li>
                        <li class="breadcrumb-item active">Shelf Life</li>
                    </ol>
                </div><!-- /.col -->
                <p id="menu"></p>
            </div><!-- /.row -->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#subchild-MNU23").addClass("nav-link active")
        });
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            data: {
                                ...
                                data_items: `[{"flag":"Insert","id":"model_shelf_life-1","code":"${code}","description":"${description}"}]`
                            },
        ...
        function loadData(page = 1, start = 1, limit = 25, search = "") {
            ...
            $.ajax({
                url: `/get-abbreviation?action=getEntity&page=${page}&start=${start}&limit=${limit}&filter=[{"operator":"like","value":"${search}","property":"entity_code_name","type":"string"},{"operator":"like","value":"shelflife","property":"entity_name","type":"string"}]`,
                type: 'get',
                dataType: 'json',
                success: function(response) {
