...
<div class="content-wrapper">
    ...
    <script>
        ...
        function loadData(page = 1, start = 1, limit = 25, search = "") {
            ...
            $.ajax({
                url: `/getDataTableMaterialType?action=getEntity&page=${page}&start=${start}&limit=${limit}&filter=[{"operator":"like","value":"service_type","property":"entity_name","type":"string"},{"operator":"like","value":"${search}","property":"entity_code_name","type":"string"}]`,
                type: 'get',
                dataType: 'json',
                success: function(response) {
