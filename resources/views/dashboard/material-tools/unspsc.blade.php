...
@section('title', 'UNSPSC Data Tools')
@section('content')
    <style>
        .btn-circle.btn-xl {
            width: 70px;
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid mt-3">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">UNSPSC Data Tools</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="col-lg-6">
                    <div class="card p-4 mb-1 m-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" id="inc-id-detail"
                                        placeholder="">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-9">
                                <div class="input-group mb-2">
                                    <input type="text"  class="form-control" id="name_inc" placeholder="">
                                </div>
                            </div>
                            <label for="" class="col-sm-3">Short: </label>
                            <div class="col-sm-9">
                                <div class="input-group mb-2">
                                    <input type="text" readonly class="form-control" id="short_inc" placeholder="">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group mb-2">
                                    <textarea type="text"  class="form-control" id="desc_inc" placeholder=""> </textarea>
                                </div>
                            </div>
                            <label for="" class="col-sm-3">MGC: </label>
                            <div class="col-sm-9">
        ...
        <script>
            ...
            function loadMgcByInc(inc, start, limit, page) {
                $.ajax({
                    ...
                    url: '/getMgcByInc?&filter=[{"operator":"eq","value":"' + inc +
                        '","property":"inc","type":"string"},{"operator":"eq","value":"Service","property":"transaction_type","type":"string"}]&page=' +
            ...
            function loadMGCAll(start, limit, page) {
                $.ajax({
                    method: "GET",
                    url: '/getGroupClassM?query=&filter=[{"operator":"eq","value":"Service","property":"transaction_type","type":"string"}]&page=' +
                        page + '&start=' + start + '&limit=' + limit,
                    data: {
                        _token: csrf_token
                    }
