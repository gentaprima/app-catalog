...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <script>
            $.ajax({
                method: "GET",
                url: '/getMultiViewCatalogM?_dc=1666710857918&start=0&limit=25&action=getMultiView&page=1&sort=[{"property":"adr_d_items_id","direction":"ASC"}]&filter=[{"operator":"eq","value":"Material","property":"transaction_type","type":"string"}]',
                dataType: "json"
