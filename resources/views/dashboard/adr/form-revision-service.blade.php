...
@section('title','Form Revision | Service')
@section('content')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid mt-3">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Form Revision Service</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">ADR & History</li>
                        <li class="breadcrumb-item active">Form Revision Service</li>
                    </ol>
                </div><!-- /.col -->
                <p id="menu"></p>
            </div><!-- /.row -->
        ...
        <div class="row">
            <div class="col-sm-7">
                <div class="card p-4 mb-5 m-2">
                    <a href="/revision-service" class="btn btn-primary" style="max-width: 100px;"><i class="fa fa-arrow-left"></i> Back</a>
    ...
    <script>
        ...
        function searchCatolog() {
            ...
            $.ajax({
                type: 'GET',
                dataType: 'json',
                url: `/getRevisionCatalogM?filter=[{"operator":"eq","value":"${catologueNo}","property":"catalog_no","type":"string"},{"operator":"eq","value":"Service","property":"transaction_type","type":"string"}]&action=getRevisionCatalogM&_token=${csrf_token}`,
        ...
        function materialApplyChange() {
            ...
            $.ajax({
                type: "post",
                url: groupName == 'User' || groupName == 'Cat' || groupName == 'Proc' ? 'RequestItemsRevision' : 'ApproveItemsRevision',
                dataType: 'json',
                data: {
