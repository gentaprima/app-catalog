...
@section('title','Revision | Service')
@section('content')
...
<div class="content-wrapper">
    ...
    <script>
        ...
        function loadData(page = 1, start = 1, limit = 25) {
            ...
            $.ajax({
                url: `/getRevisionRequestM?page=${page}&start=${start}&limit=${limit}&filter=[{"operator":"eq","value":"Service","property":"transaction_type","type":"string"}]`,
                type: 'get',
                dataType: 'json',
