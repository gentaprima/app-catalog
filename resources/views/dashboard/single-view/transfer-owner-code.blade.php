...
@section('title','Single View | Transfer Owner Code')
@section('content')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid mt-3">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Transfer Owner Code</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item">Single View</li>
                        <li class="breadcrumb-item active">Transfer Owner Code</li>
                    </ol>
                </div><!-- /.col -->
                <p id="menu"></p>
            </div><!-- /.row -->
    ...
    <section class="content">
        ...
        <div class="card p-4 mb-5 m-2">
            <h4>List Transfer Owner Code</h4>
            <hr>
            <form action="">
                <div class="form-group row">
                    <label for="" class="col-sm-2">Owner Code</label>
                    <div class="col-sm-10">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#subchild-MNU44").addClass("nav-link active")
        });
        ...
        function prosesTransport() {
            let ownerCode = document.getElementById("ownerCode").value;
            let newOwnerCode = document.getElementById("newOwnerCode").value;

            console.log(ownerCode + " " + newOwnerCode);
