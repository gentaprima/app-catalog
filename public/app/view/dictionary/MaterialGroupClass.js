...
Ext.application({
    ...
    launch: function(){
        ...
        //////////////////////////
        var model_material_group_class = Ext.define('model_material_group_class', {
        ...
        var store_material_group_class = Ext.create('Ext.data.Store', {
            storeId: 'store_material_group_class'+page,
            model: model_material_group_class,
            remoteFilter:true,
            remoteSort:true,
            autoLoad: true,
        ...
        store_material_group_class.filter(filters);
        store_material_group_class.proxy.extraParams = {
            action :'getGroup'
        };

        store_material_group_class.load({
            params:{
                start:0,
                limit:3000
            }
        ...
        var grid_material_group_class = Ext.create('Ext.grid.Panel', {
            frame: true,
            title: 'List '+title,
            iconCls: 'icon-grid',
            store: store_material_group_class,
            features: [
                {
                    id: 'group',
