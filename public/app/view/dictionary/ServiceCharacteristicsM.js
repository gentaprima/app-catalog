...
Ext.application({
    ...
    launch: function(){
        ...
        /////////////////////////////
        var ServiceMetaDataModel = Ext.define('ServiceMetaDataModel', {
            extend: 'Ext.data.Model',
            fields: ['id','mrcode', 'transaction_type','characteristic','status']
        });
        var store_service_characteristics_m = Ext.create('Ext.data.Store', {
            storeId: 'store_service_characteristics_m'+page,
            model: ServiceMetaDataModel,
            remoteFilter:true,
            remoteSort:true,
            autoLoad: false,
            proxy: {
            ...
            listeners: {
                ...
                load: function(store, records, success, operation, options){
                    // console.log(Ext.getCmp('grid_service_characteristicsM'+page));
                    // Ext.getCmp('grid_service_characteristicsM'+page).body.mask('Loading Data ....','x-mask-loading');
                    if(success){
                        // Ext.getCmp('grid_service_characteristicsM'+page).body.unmask();
                    }
                    // this.myMask.hide();
                    //
                }
        ...
        store_service_characteristics_m.filter(filters);
        store_service_characteristics_m.proxy.extraParams = {
            // filter: Ext.encode(filters),
            action :'getCharacteristicsM'
        };

        store_service_characteristics_m.reload({
            params:{
                start:0,
                limit:25
            }
        ...
        var editor_grid_service_characteristicsM =  Ext.create('Ext.grid.plugin.RowEditing', {
            licksToMoveEditor: 1,
            autoCancel: true,
        ...
        var grid_service_characteristicsM = Ext.create('Ext.grid.Panel', {
            title: 'List '+title,
            id:'grid_service_characteristicsM'+page,
            border:false,
            region: 'center',
            store: store_service_characteristics_m,
            frame:true,
            columns: [
                {
                    text: 'Code',
                ...
                },
                {
                    ...
                    editor:{
                        xtype: 'textfield',
                        id:'service_characteristics_m'+page
                    },
                },
                {
                    text: 'Status',
            ...
            tbar:[
                {
                    ...
                    handler: function() {
                        ...
                        var transaction_type = 'Service';
                        store_service_characteristics_m.each(function(r,i){
                            data.push(r.data);
                            order++ ;
                            index++ ;
                        });
                        // Create a model instance
                        var r = Ext.create('ServiceMetaDataModel', {
                            flag :'insert_char',
                            characteristic :'',
                            mrcode: mrcode,
                        ...
                        store_service_characteristics_m.insert(index, r);
                        editor_grid_service_characteristicsM.startEdit(r, 0);
                ...
                },
                {
                    ...
                    handler: function() {
                        var records = grid_service_characteristicsM.getSelectionModel().getSelection()[0];
                        if (records) {
                            // console.log(records);
                            Ext.MessageBox.show({
                                title:'Warning',
                                            ...
                                            if(r.data.status !=='Not Used'){
                                                ...
                                                Ext.Ajax.request({
                                                    ...
                                                    success:function(response, request){
                                                        ...
                                                        store_service_characteristics_m.load({
                                                            params:{
                                                                start:0,
                                                                limit:25
                                                            }
            ...
            plugins:[
                'gridfilters',
                editor_grid_service_characteristicsM
            ],
            listeners: {
        ...
        // editor_grid_service_characteristicsM.on({
        // scope: this,
        // beforeedit: function(roweditor, context) {
        //
        // },
        // afteredit: function(roweditor, context) {
        // var row = grid_service_characteristicsM.getSelectionModel().getSelection()[0];
        // var data = [] ;
        ...
        // url: 'ajax.handler.byname.php?name=characteristics',
        // method: 'POST',
        // dataType: 'json',
        // params:{
        // action:'SaveCharacteristicsM',
        // data_items :'['+data+']',
        // },
        // success:function(response, request){
        // // Ext.getCmp('transaction_code'+page).setValue(request.result.transaction_code);
        ...
        // },
        // canceledit : function(){
        // if (grid_service_characteristicsM.getSelectionModel().hasSelection()) {
        // var row = grid_service_characteristicsM.getSelectionModel().getSelection()[0];
        // }
        // }
        // });
