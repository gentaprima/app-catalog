...
Ext.application({
    ...
    launch: function(){
        ...
        // Import Data
        // ====================================================================================
        var winImportDataCleansingService = new Ext.Window({
            id: 'winImportDataCleansingService'+page,
            layout: 'fit',
            constrain: true,
            autoHeight: true,
            plain: true,
            ...
            items : [
                {
                    bodyPadding: '10 10 0',
                    xtype:'form',
                    id:'formImportDataCleansingService'+page,
                    items: [
                        {
                            xtype: 'filefield',
                            name: 'file_excel',
                    ...
                    buttons: [
                        {
                            text: 'Import',
                            handler:function(){
                                var formImportDataCleansingService = Ext.getCmp('formImportDataCleansingService'+page);
                                Ext.MessageBox.show({
                                ...
                                formImportDataCleansingService.form.submit({
                                    scope:this,
                                    ...
                                    success:function(response, request){
                                        ...
                                        winImportDataCleansingService.animateTarget = 'AddImportDataCleansing'+page;
                                        winImportDataCleansingService.hide();
            ...
            tbar: [
                {
                    ...
                    handler: function(){
                        winImportDataCleansingService.animateTarget = 'AddImportDataCleansing'+page;
                        winImportDataCleansingService.setTitle("Import Data Cleansing Service"),
                        winImportDataCleansingService.show();
                    }
                },
            ],
            columns: [
        ...
        var main_content = {
                                            ...
                                            items:[
                                                {
                                                    ...
                                                    layout: 'border',
                                                    border:false,
                                                    id:'formImportCleansingService'+page,
                                                    items:[grid_import_cleansing_material]
                                                    // items:adr_grid
                                                }
                                            ]
            ...
            listeners:{
                destroy:function(){
                    winImportDataCleansingService= Ext.getCmp('winImportDataCleansingService'+page);
                    if (winImportDataCleansingService)
                        winImportDataCleansingService.destroy();
                }
            }
