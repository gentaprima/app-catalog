...
Ext.application({
    ...
    launch: function(){
        ...
        function SearchServiceMultiview(){
            ...
            var service_filter_colum = Ext.getCmp('SearchFilterOn'+page).getValue();
            var service_filter_date = Ext.Date.format(Ext.getCmp('on_filter_date'+page).getValue(), 'Y-m-d');
...
/// task 4a begin
var ServiceFuncColumFilter = new Ext.util.Filter({
    operator: 'eq',
    value:  service_filter_date,
    property: service_filter_colum,
    type: "string",
});
...
if((isEmpty(service_filter_date) == false) && (isEmpty(service_filter_colum) == false)) {
    filters.push(ServiceFuncColumFilter['initialConfig']) ;
}
/// task 4 end
            var transaction_type = new Ext.util.Filter({
                operator: 'eq',
