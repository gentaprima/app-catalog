        ...
        function MaterialWorkFlow(){
            ...
            switch(true ){
                ...
                case (item_status === "REVISION"):
                    ...
                    //Status User //
                    ////////////////
                    alert('sebelum status user line 2549');
        ...
        function SearchMaterialCatalogNo(){
            ...
            Ext.getBody().mask("loading material item...");
             if(val){
                ...
                alert('sebelum callback line 2892');
                var filters = [];
                var catalog_no = new Ext.util.Filter({
                    operator: 'eq',
                    value:  val,
                ...
                alert('sebelum callback line 2919');
                store_material_catalog_m.reload({
                    ...
                    callback : function(records, operation, success) {
                        if(success){
                            alert('sebelum callback line 2929');
                            ...
                            if(store_material_catalog_m.getCount() > 0){
                                ...
                                alert('sebelum catagory line 3028');
                                //////////////
                                // Catagory //
                                //////////////
                                ...
                                alert('sebelum material flow line 3186');
                                MaterialWorkFlow();
                            }else{
