    ...
    launch: function(){
        ...
        var grid_material_abbr = Ext.create('Ext.grid.Panel', {
            ...
            listeners: {
               ...
               beforequery: function(item,value,queryEvent){
               },
     ...
     /*   var model_material_abbr = Ext.define('model_material_abbr', {
		...
		*/
        ...
        //////////////////////////////
        // Grid Material Owner Code //
        //////////////////////////////
        var model_material_OwnerCode = Ext.define('model_material_OwnerCode', {
            extend: 'Ext.data.Model',
            fields: ['trx_no','catalog_no','old_owner_code', 'new_owner_code', 'tgl']
        });
        var store_material_OwnerCode = Ext.create('Ext.data.Store', {
            storeId: 'store_material_OwnerCode'+page,
            model: model_material_OwnerCode,
            proxy: {
                type: 'ajax',
                url: '/geTrxCodeHisto',
                method: 'GET',
        ...
        var grid_material_OwnerCode = Ext.create('Ext.grid.Panel', {
            width: 500,
            height: 250,
            margin: '0 0 0 0',
            store:store_material_OwnerCode,
            hideHeaders:false,
            columns:[
                {
                    xtype:'rownumberer',
        ...
        var winMaterialOwnerCode = Ext.widget('window', {
            id:'winMaterialOwnerCode'+page,
            layout       : 'fit',
            constrain    : true,
            width: 500,
            height: 200,
            ...
            closable: false,
            items: [
                grid_material_OwnerCode
            ],
            tools: [
                {
                    type: 'close',
                    handler: function () {
                        winMaterialOwnerCode.animateTarget = 'btnMaterialOwnerCode'+page;
                        winMaterialOwnerCode.hide();
                    }
                }
            ],
        });
                                                                                    ...
                                                                                    handler: function() {
                                                                                      ...
                                                                                      var catno =Ext.getCmp('catalog_no'+page).getValue();
                                                                                       if (catno) 
                                                                                         { 
                                                                                            winMaterialOwnerCode.animateTarget = 'btnMaterialOwnerCode'+page;
                                                                                            winMaterialOwnerCode.setTitle("Owner Data Tranport, Catalog No."+Ext.getCmp('catalog_no'+page).getValue()),
                                                                                            winMaterialOwnerCode.show();
                                                                                            var filters = [];
                                                                                            var adr_d_items_id_filter = new Ext.util.Filter({
                                                                                                operator: 'eq',
                                                                                                value: catno,
                                                                                            ...
                                                                                            filters.push(adr_d_items_id_filter['initialConfig']) ;
                                                                                            store_material_OwnerCode.proxy.extraParams = {
                                                                                                filter: Ext.encode(filters),
                                                                                                action:'geTrxCodeHisto'
                                                                                            };
                                                                                            store_material_OwnerCode.load({
                                                                                                params:{
                                                                                                    // action : 'getInc',
                                                                                                    // filter: Ext.encode(filters),
                                                                                                }
