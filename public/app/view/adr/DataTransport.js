...
//end of bug 11
        ...
        var model_adr_item_list = Ext.define('model_adr_item_list', {
            extend: 'Ext.data.Model',
            fields: ['trx_no','adr_m_id', 'catalog_no','sap_material_code', 'raw', 'transaction_type', 'groupclass', 'inc', 'longdesc','adr_status','adr_item_status']
        });
                            ...
                            items: [
                                {
                                    ...
                                    emptyText:'Select Trx Code...',
                                    selectOnFocus:false,
                                    margin: '3 3 3 0',
                                    id: 'SearchTrxCodeTransfer',
                                    name:           'ComboTrxCode',
                                    hiddenName:     'new_owner_code',
                                    displayField:   'trx_no',
                                    valueField:     'trx_no',
                                    minChars : 0,
                                    listConfig: {
                                        ...
                                        getInnerTpl: function() {
                                            return '{trx_no} <span style="font-size: xx-small; ">{new_owner_code}</span>';
                                        }
                                    },
                                    ...
                                    listeners: {
                                        ...
                                        beforequery: function(queryEvent, eOpts ,value) {
                                            ...
                                            var entity_name = new Ext.util.Filter({
                                                ...
                                                property: "new_owner_code",
                                                type: "string",
                                            });

                                            filters.push(entity_name['initialConfig']) ;
                                            var Isactif = new Ext.util.Filter({
                                                operator: 'eq',
                                                value: 1,
                                                property: "is_active",
                                                type: "string",
                                            ...
                                            filters.push(Isactif['initialConfig']) ;
                                        ...
                                        select: function(combo) {
                                            vComboTrxOwnwer =combo.getValue();
