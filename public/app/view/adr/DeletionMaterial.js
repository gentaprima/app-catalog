valid_script = true;
// ROLE = Ext.decode('{"ProcApp":true,"StdApp":true,"RemoveRequestRevision":true,"AddRequestBlocked":true,"Plant":true,"RemoveCrossReferences":true,"RemoveFuncLoctaion":true,"StockClass":true,"StockType":true,"UOM":true,"Category":true,"MaterialType":true,"ViewNotes":true,"ApplyChangeMaterial":true,"Cataloguer":true,"AddCrossReferences":true,"MovingType":true,"MaxStock":true,"RemoveMaterial":false,"AddMaterial":false,"AddRequestBlocked":true,"AppRequestBlocked":false,"AddAdditionSubmit":true,"AddFuncLocation":true,"ApproveRevisionReq":false,"INC":true,"MGC":true,"ApprovalBlocked":false,"InvButtonCatalogNoHis":false}');
...
//////////////////////////////////
        ...
        var winBlockedMaterialRawSource = Ext.widget('window', {
            id:'winBlockedMaterialRawSource'+page,
            layout       : 'fit',
            constrain    : true,
            width: 450,
            height: 250,
            ...
            tools: [
                {
                    type: 'close',
                    handler: function () {
                        winBlockedMaterialRawSource.animateTarget = 'btnMaterialViewRaw'+page;
                        winBlockedMaterialRawSource.hide();
                    }
                }
            ],
        });
            ...
            bbar:[
                {
                    ...
                    handler:function(){
                        ...
                        winBlockedDetailMaterialDocument.animateTarget = 'addMatDocument'+page;
                        winBlockedDetailMaterialDocument.show();
                    }
                },
                Ext.create('Ext.PagingToolbar', {
                    border:false,
        ...
        var
            winBlockedDetailMaterialDocument = new Ext.Window({
                // title:'Documens Catalog No. '+ Ext.getCmp('material_catalog_no'+page).getValue(),
                id: 'winBlockedDetailMaterialDocument'+page,
                layout       : 'fit',
                constrain    : true,
                width: 450,
                height: 150,
                                ...
                                handler:function(){
                                    ...
                                    formMaterialImagesUplod.form.submit({
                                        ...
                                        success:function(response, request){
                                            ...
                                            winBlockedDetailMaterialDocument.hide();
        ...
        var winBlockedMaterialDocument = Ext.widget('window', {
            // title: 'Document'+ Ext.getCmp('catalog_no'+page).getValue(),//+ ,
            id:'winBlockedMaterialDocument'+page,
            layout       : 'fit',
            constrain    : true,
            // height       : 500,
            // width        : 650,
            ...
            tools: [
                {
                    ...
                    handler: function () {
                        // frmEFakturRequestShow.animateTarget = 'AddDataM'+page;
                        winBlockedMaterialDocument.hide();
                    }
                }
            ],
        });
...
//////////////////////////////////
            ...
            bbar:[
                {
                    ...
                    hidden:false,
                    handler:function(){
                        winBlockedDetailMaterialImagesSource.animateTarget = 'addMaterialIncImages'+page;
                        winBlockedDetailMaterialImagesSource.show();
        ...
        var winBlockedDetailMaterialImagesSource = new Ext.Window({
            id: 'winBlockedDetailMaterialImagesSource'+page,
            layout       : 'fit',
            constrain    : true,
            width: 450,
            height: 150,
                            ...
                            handler:function(){
                                ...
                                formMaterialImagesUplod.form.submit({
                                    ...
                                    success:function(response, request){
                                        ...
                                        winBlockedDetailMaterialImagesSource.hide();
        ...
        var winBlockedMaterialImagesSource = Ext.widget('window', {
            id:'winBlockedMaterialImagesSource'+page,
            layout       : 'fit',
            constrain    : true,
            plain: true,
            bodyPadding  : '0 0 0 0',
            ...
            tools: [
                {
                    type: 'close',
                    handler: function () {
                        winBlockedMaterialImagesSource.animateTarget = 'btnMaterialViewImages'+page;
                        winBlockedMaterialImagesSource.hide();
                    }
                }
            ],
        });
...
//////////////////////////////
        ...
        var winBlockedMaterialViewNotes = Ext.widget('window', {
            id:'winBlockedMaterialViewNotes'+page,
            layout       : 'fit',
            constrain    : true,
            width: 1000,
            height: 300,
            ...
            tools: [
                {
                    type: 'close',
                    handler: function () {
                        winBlockedMaterialViewNotes.animateTarget = 'btnMaterialViewNotes'+page;
                        winBlockedMaterialViewNotes.hide();
                    }
                }
            ],
        });
        ...
        //////////////////////
        function BlockedMaterialStatusStyle(){
        ...
        ///////////////////////////
        function BlockedMaterialWorkFlow(){
            BlockedMaterialStatusStyle();
            var record = store_blocked_material_catalog_m.getData().items[0];
            var str = record.data.item_status;
            ...
            MaterialBlockedChanges = true;
            MaterialApproveBlocked= true;
            ...
            switch(true ){
                ...
                ////////////////
                    //Status User //
                    ////////////////
                    if(!empty(record.data.blocked_adr_d_items_id) && record.data.status_user === 1){
                        ...
                        if (company_code === record.data.company_code && user_level === "Cat") {
                            readOnly = false;
                            MaterialCharacteristicsEditor = false ;
                            MaterialBlockedChanges = false;
                            MaterialApproveBlocked= false;
                        ...
                        if (company_code === record.data.company_code && user_level === "User" ) {
                            readOnly = false;
                            MaterialCharacteristicsEditor = false ;
                            MaterialBlockedChanges = false;
                            MaterialFuncLoc = false;
                    ...
                    Ext.getCmp('btnRequestForBlocked'+page).setDisabled(MaterialBlockedChanges);
                    // Ext.getCmp('btnRequestBlocked'+page).setVisible(false);

                    Ext.getCmp('btnApprovalForBlocked'+page).setDisabled(MaterialApproveBlocked);
        ...
        ////////////////////////////
        // SearchBlockedMaterialCatalogNo //
        ////////////////////////////
        function SearchBlockedMaterialCatalogNo(){
            var val = Ext.getCmp('catalog_no'+page).getValue();
            Ext.getCmp('form_blocked_material'+page).mask("loading material item...");
            if(val){
                Ext.getCmp('MaterialRibbonUser'+page).removeCls('RibbonGrey');
                Ext.getCmp('MaterialRibbonUser'+page).removeCls('RibbonYellow');
                Ext.getCmp('MaterialRibbonUser'+page).removeCls('RibbonGreen');
                    ...
                    callback : function(records, operation, success) {
                        if(success){
                            ...
                            if(store_blocked_material_catalog_m.getCount() > 0){
                                ...
                                Ext.getCmp('form_blocked_material'+page).unmask();
                                ...
                                store_blocked_material_reason.removeAll();
                                ...
                                form_blocked_material.getForm().getFields().each (function (field) {
        ...
        var grid_blocked_material_reason = Ext.create('Ext.grid.Panel', {
            title: 'Reason',
            // region: 'center',
            height:200,
            // collapsible:true,
            // width :300,
            anchor:'75%',
            id: 'grid_blocked_material_reason'+page,
        ...
        //////////////////////////////
        var form_blocked_material = Ext.create('Ext.form.Panel', {
            height:550,
            autoHeight:true,
            layout:'border',
            id:'form_blocked_material'+page,
            fieldDefaults: {
        ...
        // --WINDOWS - REVISION
        // =====================================================================
        var winMaterialBlocked = new Ext.Window({
            title:'Form Request For Blocked',
            id: 'winMaterialBlocked'+page,
            layout       : 'fit',
            constrain    : true,
            ...
            // padding : '1 1 1 1',
            items : [
                form_blocked_material
            ],
            tools: [
                {
                    type: 'close',
                    handler: function () {
                        winMaterialBlocked.hide();
                        form_blocked_material.getForm().reset();
                        // store_REV.reload();
                        // ResetWindowRevision();
            ...
            bbar:[
                ...
                '-',
                {
                    ...
                    handler: function() {
                        ...
                        form_blocked_material.form.submit({
                            scope:this,
                ...
                '-',
                {
                    ...
                    handler: function() {
                        ...
                        var uom = Ext.getCmp('material_uom'+page).getValue();
                        var category = Ext.getCmp('material_category'+page).getValue() ;
                        var reason = Ext.getCmp('reason'+page).getValue() ;

                        if(isEmpty(reason) == true ){
                            Ext.MessageBox.show({
                                title : 'Warning',
                                msg:'Please Reason' ,
                                buttons: Ext.MessageBox.OK,
            ...
            tbar:[
                {
                    ...
                    handler:function(){
                        ...
                        Ext.getCmp('MaterialRibbonProccApp'+page).removeCls('RibbonRed');
                        Ext.getCmp('MaterialRibbonProccApp'+page).addCls('RibbonGrey');
                        winMaterialBlocked.animateTarget = 'AddRequestBlocked'+page;
                        winMaterialBlocked.show();
                    }
                },
                {
                    cls: 'x-btn-default-small',
                    ...
                    handler:function(){
                        ...
                        Ext.getCmp('MaterialRibbonProccApp'+page).removeCls('RibbonRed');
                        Ext.getCmp('MaterialRibbonProccApp'+page).addCls('RibbonGrey');
                        winMaterialBlocked.animateTarget = 'btnAddRequestBlocked'+page;
                        winMaterialBlocked.show();
                    }
                },
            ],
        ...
        var main_content = {
            ...
            listeners:{
                destroy:function(){
                    ...
                    // // Revision
                    // // ==================================================================
                    winMaterialBlocked = Ext.getCmp('winMaterialBlocked'+page);
                    if (winMaterialBlocked){
                        winMaterialBlocked.destroy();
                    }
