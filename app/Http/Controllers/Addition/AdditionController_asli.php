...
class AdditionController extends Controller
{
	...
	public function TestMail() {
                            $data = array(
                                'from'=>'achmad.maududi@abm-investama',
                                'catalog_no'=>'X125',
                                'short_text'=>'NBAX',
                                'regard'=> 'Achmad'
                            );		
		...
		{
			$emailSender = "ecat@abm-investama.co.id";

			$message->from($emailSender ,'ABM E-Cataloguing Systems')
				->to('achmad.maududi@abm-investama.co.id', 'ABM E-Cataloguing Systems')
